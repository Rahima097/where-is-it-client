        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <div className="flex gap-4">
              <a href="https://www.facebook.com/maanvia.khan/" target="_blanck" className="text-secondary hover:text-primary">
                <Facebook size={20} />
              </a>
              <a href="#" target="_blanck" className="text-secondary hover:text-primary">
                <Twitter size={20} />
              </a>
              <a href="https://www.linkedin.com/in/rahima-khatun28/" target="_blanck" className="text-secondary hover:text-primary">
                <Linkedin size={20} />
              </a>
            </div>
          </div>
